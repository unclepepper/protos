...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterResponse)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *RegisterRequest) (*RegisterResponse, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *RegisterRequest) (*RegisterResponse, error) {
...
func _Auth_IsAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).IsAdmin(ctx, req.(*RegisterRequest))
	}
	return interceptor(ctx, in, info, handler)
}

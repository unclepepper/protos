...
type LoginRequest struct {
	...
	AppId         int32                  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // Password of the user login
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x05Login\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x128\n" +
	"\aIsAdmin\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponseB\x1aZ\x18unclepepper.sso.v1;ssov1b\x06proto3"
